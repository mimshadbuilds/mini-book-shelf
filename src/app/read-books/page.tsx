...
const ReadBooks = () => {
    ...
    const data = readBooks.map((book: IBook, ind: number) => {
    return {
        name: book.bookName,
        uv: ind + 1,
        pv: ind + 1,
    ...
    return (
        <div className='max-w-[1240px] flex justify-center items-center mx-auto my-16 bg-slate-100 shadow-sm rounded-2xl p-15'>
        {
            readBooks.length > 0 
            ? <BarChart
